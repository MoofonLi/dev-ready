...
Status: v0.9 released (2026-08-01). FR-30, FR-31, and FR-35 are shipped in
v0.9.0. Historical scope and roadmap details are in docs/version-plan.md.
...
10. v0.10: assembly and reach — Mount Points (FR-32), Agent Target Map (FR-33), interview-driven generation skill (FR-34), selection reach and overlay-infrastructure corrections (FR-36), tech stack and standards sources in the generated `AGENTS.md` (FR-37). PLANNED.
