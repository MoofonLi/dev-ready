...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/MoofonLi/dev-ready/blob/main/LICENSE)
...
![A recorded interactive `dev-ready init`: Engineering Flow comparison, Category prompts, confirmation, progress stages, and the generation report.](https://raw.githubusercontent.com/MoofonLi/dev-ready/main/docs/assets/demo.gif)
...
The source is [skills/dev-ready/SKILL.md](https://github.com/MoofonLi/dev-ready/blob/main/skills/dev-ready/SKILL.md). Inspect discoverable skills first:
...
See [AGENTS.md](https://github.com/MoofonLi/dev-ready/blob/main/AGENTS.md). Full CLI contract: [docs/cli-spec.md](https://github.com/MoofonLi/dev-ready/blob/main/docs/cli-spec.md). Version overview: [v0.13 overview](https://github.com/MoofonLi/dev-ready/blob/main/docs/version_overview/v0.13-overview.md).

## License

MIT — see [LICENSE](https://github.com/MoofonLi/dev-ready/blob/main/LICENSE). Generated projects include third-party content; see [THIRD_PARTY_NOTICES.md](https://github.com/MoofonLi/dev-ready/blob/main/THIRD_PARTY_NOTICES.md).
