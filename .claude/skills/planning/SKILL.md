...
The authoritative version of this skill lives at `.agents/skills/planning/SKILL.md`
(open Agent Skills format, ADR-011). This file is only a Claude Code discovery stub.

Read `.agents/skills/planning/SKILL.md` in full and follow it exactly. Do not act
on this stub alone.
